    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                ...
                <span class=" d-lg-block">ZNC-ADMIN</span>
            </a>
        </div><!-- End Logo -->
    </header><!-- End Header -->
...
<footer id="footer" class="footer" style="position: sticky;">
    <div class="copyright">
        &copy; Copyright <strong><span>ZAHIRA COLLEGE</span></strong>. All Rights Reserved
    </div>
